...
using SP_DEVICE_INTERFACE_DATA = Test_tool4product_line.WindowsAPI.SP_DEVICE_INTERFACE_DATA;
using SP_DEVICE_INTERFACE_DETAIL_DATA = Test_tool4product_line.WindowsAPI.SP_DEVICE_INTERFACE_DETAIL_DATA;
